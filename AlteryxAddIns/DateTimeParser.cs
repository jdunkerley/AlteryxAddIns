...
namespace JDunkerley.AlteryxAddIns
{
    ...
    public class DateTimeParser : BaseTool<DateTimeParser.Config, DateTimeParser.Engine>, IPlugin
    {
        public class Config : ConfigWithIncomingConnection
        {
            ...
            [InputPropertyName(nameof(Engine.Input), typeof(Engine), FieldType.E_FT_String, FieldType.E_FT_V_String,
            ...
            private void OnInit(IInputProperty sender, SuccessEventArgs args)
            {
                var fieldDescription = new FieldDescription(
                                           ...
                                           this.ConfigObject.OutputType)
                                           {
                                               ...
                                               Description =
                                                   $"{this.ConfigObject.InputFieldName} parsed as a DateTime"
                                           };
