...
{
    /// <summary>
    ///     Interface to decouple the construction of <see cref="IRecordCopier" /> objects from
    ...
    public interface IRecordCopierFactory
    {
        ...
        IRecordCopier CreateCopier(RecordInfo info, RecordInfo newRecordInfo, params string[] fieldsToSkip);
    }
}